...
> {
  ...
  private _schema?: {
    ...
    PAYMENT_CARD_AUTHZN_RELATION_ID: OrderableEdmTypeField<
      ...
      true
    >;
    DIGITAL_PAYMENT_TRANS_ID: OrderableEdmTypeField<
      SlsOrdPaymentPlanItemDetails<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link digitalPaymentTransId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DIGITAL_PAYMENT_TRANS_ID: fieldBuilder.buildEdmTypeField(
