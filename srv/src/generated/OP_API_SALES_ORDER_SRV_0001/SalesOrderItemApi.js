    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                PROPOSED_DELIVERY_ROUTE: fieldBuilder.buildEdmTypeField('ProposedDeliveryRoute', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                MEANS_OF_TRANSPORT_TYPE: fieldBuilder.buildEdmTypeField('MeansOfTransportType', 'Edm.String', true),
                /**
                 * Static representation of the {@link meansOfTransportRefMaterial} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                MEANS_OF_TRANSPORT_REF_MATERIAL: fieldBuilder.buildEdmTypeField('MeansOfTransportRefMaterial', 'Edm.String', true),
                /**
                 * Static representation of the {@link specialProcessingCode} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                SPECIAL_PROCESSING_CODE: fieldBuilder.buildEdmTypeField('SpecialProcessingCode', 'Edm.String', true),
                /**
