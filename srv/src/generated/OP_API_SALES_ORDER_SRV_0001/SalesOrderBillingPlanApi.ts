...
> implements EntityApi<SalesOrderBillingPlan<DeSerializersT>, DeSerializersT> {
  ...
  private _schema?: {
    ...
    REFERENCE_BILLING_PLAN: OrderableEdmTypeField<
      ...
      true
    >;
    PAYMENT_LINK_IS_REQUIRED: OrderableEdmTypeField<
      SalesOrderBillingPlan<DeSerializers>,
      DeSerializersT,
      'Edm.Boolean',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link paymentLinkIsRequired} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PAYMENT_LINK_IS_REQUIRED: fieldBuilder.buildEdmTypeField(
